...
import EditPackageValidation from "./validation";
...
const EditPackageForm = () => {
  ...
  useRestCallEffect(async () => {
    const ptPackage: PTPackageResponse =
      await personalTrainerService.getPTPackageById(packageId);

    setInitialValues({
      packageName: ptPackage.packageName,
      packageDescription: ptPackage.packageDescription,
      unitAmount: ptPackage.price,
      workoutType: ptPackage.workoutType,
    });
    ...
    <>
      ...
      {!isLoading && (
        <Formik
          ...
          validationSchema={EditPackageValidation}
          enableReinitialize={true}
          onSubmit={onSubmit(packageId, setToastSettings)}
        >
              ...
              >
                <Field as="div" name="languages">
                  <MultiSelect
                    ...
                    selectedValues={workoutTypes.filter((i) =>
                      initialValues.workoutType.includes(i.id)
                    )}
                    onChange={(el) => {
                      setFieldValue(
                        "workoutType",
